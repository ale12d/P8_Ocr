...
class SignInForm(forms.Form):
    ...
    password = forms.fields.CharField(max_length=20, widget=forms.PasswordInput)
...
class SignUpForm(forms.ModelForm):
    username = forms.fields.CharField(max_length=20)
    password = forms.fields.CharField(max_length=20, widget=forms.PasswordInput)
    confirm_password = forms.fields.CharField(max_length=20, widget=forms.PasswordInput)
